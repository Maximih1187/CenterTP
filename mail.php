...
try {
  ...
  $mail->Username   = 'benkomaksim@yandex.ru'; // Логин на почте
  $mail->Password   = 'mkcaguugysrznlqz'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('benkomaksim@yandex.ru , Заявка с сайта "тп"'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('benkomaksim@yandex.ru');
